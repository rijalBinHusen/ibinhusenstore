        ...
        <div class="row justify-center" style="margin:20px 0 0 auto;">
            <div class="col-10">
                ...
                <div class="row" style="margin-top: 20px">
                    <div class="col-5 text-subtitle1 text-weight-bold">
                        Produk
                    </div>
                    <div class="col-2 text-subtitle1 text-weight-bold">
                        Jumlah
                    </div>
                    <div class="col-2 text-subtitle1 text-weight-bold">
                        Harga
                ...
                <hr />
                <!-- Lists of product -->
                <div v-for="(product, index) in products" :key="product.id" class="row" style="margin-top: 10px;">
                    <div class="col-5">
                ...
                <div class="row justify-center" style="margin-top:30px;">
                    ...
                    <div style="margin-left:20px;">
                        <q-btn
                            :to="{ name: 'order', params: { step: 1 } }"
                            color="primary"
                            label="Buat pesanan"
                        />
                    </div>
                </div>
                <hr class="justify-center" style="margin:20px auto 40px auto; max-width: 1000px;" />
            </div>
        </div>
        <Footer />
    </div>
...
export default defineComponent({
    components: { Navbar, Footer, ProdukMiniCard },
    setup () {
